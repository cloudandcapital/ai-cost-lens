  ...
  function singleBillGuidance(review) {
    ...
    if (review.providerUnit === null) {
      ...
      return [
        ...
        ["test", "UNIT COST", costPerRequest === null ? "Add request volume when available" : "Know the blended cost per request", costPerRequest === null ? "Optional" : cost(costPerRequest), costPerRequest === null ? "Requests were not supplied for every cost row. Leave the metric blank until the source supports it." : "This is provider cost divided by all supplied requests. It is a workload-level baseline, not a model price."],
